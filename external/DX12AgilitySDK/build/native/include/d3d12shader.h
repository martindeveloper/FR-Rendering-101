...
{
    STDMETHOD(GetDesc)
    (THIS_ _Out_ D3D12_SHADER_TYPE_DESC * pDesc) PURE;
    ...
    STDMETHOD(IsEqual)
    (THIS_ _In_ ID3D12ShaderReflectionType * pType) PURE;
...
{
    STDMETHOD(GetDesc)
    (THIS_ _Out_ D3D12_SHADER_VARIABLE_DESC * pDesc) PURE;
    ...
    STDMETHOD_(UINT, GetInterfaceSlot)
    (THIS_ _In_ UINT uArrayIndex) PURE;
};
...
{
    STDMETHOD(GetDesc)
    (THIS_ D3D12_SHADER_BUFFER_DESC * pDesc) PURE;
...
DECLARE_INTERFACE_(ID3D12ShaderReflection, IUnknown)
{
    ...
    STDMETHOD(GetDesc)
    (THIS_ _Out_ D3D12_SHADER_DESC * pDesc) PURE;
    ...
    STDMETHOD_(UINT, GetMovInstructionCount)
    (THIS) PURE;
    STDMETHOD_(UINT, GetMovcInstructionCount)
    (THIS) PURE;
    STDMETHOD_(UINT, GetConversionInstructionCount)
    (THIS) PURE;
    STDMETHOD_(UINT, GetBitwiseInstructionCount)
    (THIS) PURE;

    STDMETHOD_(D3D_PRIMITIVE, GetGSInputPrimitive)
    (THIS) PURE;
    STDMETHOD_(BOOL, IsSampleFrequencyShader)
    (THIS) PURE;

    STDMETHOD_(UINT, GetNumInterfaceSlots)
    (THIS) PURE;
    ...
    STDMETHOD_(UINT64, GetRequiresFlags)
    (THIS) PURE;
};
...
DECLARE_INTERFACE_(ID3D12LibraryReflection, IUnknown)
{
    ...
    STDMETHOD(GetDesc)
    (THIS_ _Out_ D3D12_LIBRARY_DESC * pDesc) PURE;
